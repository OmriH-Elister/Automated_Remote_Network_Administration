...
4. allhostststartwinrm.ps1 - this is a powershell script loops through a list of hostnames/ipaddresses and activates the WinRM service on all of them.
5. auto_loop_allhosts_telnetenum.bat
6. enable_adapt.ps1 -This script automates the process of troubleshooting bad network settings on a remot
